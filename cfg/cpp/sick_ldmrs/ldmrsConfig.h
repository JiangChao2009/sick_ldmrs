...
namespace sick_ldmrs
{
  ...
  public:
    ...
    public:
      ...
      virtual void getValue(const ldmrsConfig &config, boost::any &val) const = 0;
    };
    ...
    public:
      ...
      virtual void getValue(const ldmrsConfig &config, boost::any &val) const
      {
        val = config.*field;
      }
    };
    ...
    class AbstractGroupDescription : public dynamic_reconfigure::Group
    {
      ...
      virtual void updateParams(boost::any &cfg, ldmrsConfig &top) const= 0;
    ...
    public:
      ...
      virtual void updateParams(boost::any &cfg, ldmrsConfig &top) const
      {
        PT* config = boost::any_cast<PT*>(cfg);
      ...
      T (PT::* field);
      std::vector<ldmrsConfig::AbstractGroupDescriptionConstPtr> groups;
    };
...
class DEFAULT
{
  public:
    ...
    void setParams(ldmrsConfig &config, const std::vector<AbstractParamDescriptionConstPtr> params)
    {
      for (std::vector<AbstractParamDescriptionConstPtr>::const_iterator _i = params.begin(); _i != params.end(); ++_i)
      {
        ...
        if("start_angle"==(*_i)->name){start_angle = boost::any_cast<int>(val);}
        if("end_angle"==(*_i)->name){end_angle = boost::any_cast<int>(val);}
        if("scan_frequency"==(*_i)->name){scan_frequency = boost::any_cast<int>(val);}
        if("sync_angle_offset"==(*_i)->name){sync_angle_offset = boost::any_cast<int>(val);}
        if("constant_angular_res"==(*_i)->name){constant_angular_res = boost::any_cast<bool>(val);}
        if("frame_id_prefix"==(*_i)->name){frame_id_prefix = boost::any_cast<std::string>(val);}
        if("use_first_echo"==(*_i)->name){use_first_echo = boost::any_cast<bool>(val);}
        if("time_smoothing_factor"==(*_i)->name){time_smoothing_factor = boost::any_cast<double>(val);}
        if("time_error_threshold"==(*_i)->name){time_error_threshold = boost::any_cast<int>(val);}
        if("apply_changes"==(*_i)->name){apply_changes = boost::any_cast<bool>(val);}
      }
    }
...
//#line 218 "/opt/ros/kinetic/share/dynamic_reconfigure/templates/ConfigType.h.template"
  ...
  class ldmrsConfigStatics
  {
    ...
    ldmrsConfigStatics()
    {
ldmrsConfig::GroupDescription<ldmrsConfig::DEFAULT, ldmrsConfig> Default("Default", "", 0, 0, true, &ldmrsConfig::groups);
//#line 259 "/opt/ros/kinetic/lib/python2.7/dist-packages/dynamic_reconfigure/parameter_generator.py"
...
//#line 259 "/opt/ros/kinetic/lib/python2.7/dist-packages/dynamic_reconfigure/parameter_generator.py"
      Default.abstract_parameters.push_back(ldmrsConfig::AbstractParamDescriptionConstPtr(new ldmrsConfig::ParamDescription<int>("start_angle", "int", 1, "The angle of the first range measurement.", "", &ldmrsConfig::start_angle)));
//#line 259 "/opt/ros/kinetic/lib/python2.7/dist-packages/dynamic_reconfigure/parameter_generator.py"
...
//#line 259 "/opt/ros/kinetic/lib/python2.7/dist-packages/dynamic_reconfigure/parameter_generator.py"
      Default.abstract_parameters.push_back(ldmrsConfig::AbstractParamDescriptionConstPtr(new ldmrsConfig::ParamDescription<int>("end_angle", "int", 1, "The angle of the last range measurement.", "", &ldmrsConfig::end_angle)));
//#line 259 "/opt/ros/kinetic/lib/python2.7/dist-packages/dynamic_reconfigure/parameter_generator.py"
...
//#line 259 "/opt/ros/kinetic/lib/python2.7/dist-packages/dynamic_reconfigure/parameter_generator.py"
      Default.abstract_parameters.push_back(ldmrsConfig::AbstractParamDescriptionConstPtr(new ldmrsConfig::ParamDescription<int>("scan_frequency", "int", 1, "Scan frequency, 0 = 12.5Hz, 1 = 25 Hz, 2 = 50 Hz", "", &ldmrsConfig::scan_frequency)));
//#line 259 "/opt/ros/kinetic/lib/python2.7/dist-packages/dynamic_reconfigure/parameter_generator.py"
...
//#line 259 "/opt/ros/kinetic/lib/python2.7/dist-packages/dynamic_reconfigure/parameter_generator.py"
      Default.abstract_parameters.push_back(ldmrsConfig::AbstractParamDescriptionConstPtr(new ldmrsConfig::ParamDescription<int>("sync_angle_offset", "int", 1, "Sychronization offset angle in degrees", "", &ldmrsConfig::sync_angle_offset)));
//#line 259 "/opt/ros/kinetic/lib/python2.7/dist-packages/dynamic_reconfigure/parameter_generator.py"
...
//#line 259 "/opt/ros/kinetic/lib/python2.7/dist-packages/dynamic_reconfigure/parameter_generator.py"
      Default.abstract_parameters.push_back(ldmrsConfig::AbstractParamDescriptionConstPtr(new ldmrsConfig::ParamDescription<bool>("constant_angular_res", "bool", 1, "Constant or focussed angular resolution type (focussed valid for 12.5Hz scan freq only)", "", &ldmrsConfig::constant_angular_res)));
//#line 259 "/opt/ros/kinetic/lib/python2.7/dist-packages/dynamic_reconfigure/parameter_generator.py"
...
//#line 259 "/opt/ros/kinetic/lib/python2.7/dist-packages/dynamic_reconfigure/parameter_generator.py"
      Default.abstract_parameters.push_back(ldmrsConfig::AbstractParamDescriptionConstPtr(new ldmrsConfig::ParamDescription<std::string>("frame_id_prefix", "str", 3, "Frame id of the sensor. Scan messages append scan number (0-3) to this", "", &ldmrsConfig::frame_id_prefix)));
//#line 259 "/opt/ros/kinetic/lib/python2.7/dist-packages/dynamic_reconfigure/parameter_generator.py"
...
//#line 259 "/opt/ros/kinetic/lib/python2.7/dist-packages/dynamic_reconfigure/parameter_generator.py"
      Default.abstract_parameters.push_back(ldmrsConfig::AbstractParamDescriptionConstPtr(new ldmrsConfig::ParamDescription<bool>("use_first_echo", "bool", 3, "Scan messages will use first echo if true, last echo otherwise", "", &ldmrsConfig::use_first_echo)));
//#line 259 "/opt/ros/kinetic/lib/python2.7/dist-packages/dynamic_reconfigure/parameter_generator.py"
...
//#line 259 "/opt/ros/kinetic/lib/python2.7/dist-packages/dynamic_reconfigure/parameter_generator.py"
      Default.abstract_parameters.push_back(ldmrsConfig::AbstractParamDescriptionConstPtr(new ldmrsConfig::ParamDescription<double>("time_smoothing_factor", "double", 3, "high values will smooth time more, low values will track noisy time more", "", &ldmrsConfig::time_smoothing_factor)));
//#line 259 "/opt/ros/kinetic/lib/python2.7/dist-packages/dynamic_reconfigure/parameter_generator.py"
...
//#line 259 "/opt/ros/kinetic/lib/python2.7/dist-packages/dynamic_reconfigure/parameter_generator.py"
      Default.abstract_parameters.push_back(ldmrsConfig::AbstractParamDescriptionConstPtr(new ldmrsConfig::ParamDescription<int>("time_error_threshold", "int", 3, "allowed error (miliseconds) between smooth time and noisy time before step correction is applied, -1 disables time correction", "", &ldmrsConfig::time_error_threshold)));
//#line 259 "/opt/ros/kinetic/lib/python2.7/dist-packages/dynamic_reconfigure/parameter_generator.py"
...
//#line 259 "/opt/ros/kinetic/lib/python2.7/dist-packages/dynamic_reconfigure/parameter_generator.py"
      Default.abstract_parameters.push_back(ldmrsConfig::AbstractParamDescriptionConstPtr(new ldmrsConfig::ParamDescription<bool>("apply_changes", "bool", 3, "Issues a restart with the new parameter value. Note: none of the changes will take effect until this is set", "", &ldmrsConfig::apply_changes)));
//#line 259 "/opt/ros/kinetic/lib/python2.7/dist-packages/dynamic_reconfigure/parameter_generator.py"
...
//#line 233 "/opt/ros/kinetic/lib/python2.7/dist-packages/dynamic_reconfigure/parameter_generator.py"
      __group_descriptions__.push_back(ldmrsConfig::AbstractGroupDescriptionConstPtr(new ldmrsConfig::GroupDescription<ldmrsConfig::DEFAULT, ldmrsConfig>(Default)));
//#line 353 "/opt/ros/kinetic/share/dynamic_reconfigure/templates/ConfigType.h.template"

      for (std::vector<ldmrsConfig::AbstractGroupDescriptionConstPtr>::const_iterator i = __group_descriptions__.begin(); i != __group_descriptions__.end(); ++i)
      {
    ...
    std::vector<ldmrsConfig::AbstractGroupDescriptionConstPtr> __group_descriptions__;
    ldmrsConfig __max__;
    ldmrsConfig __min__;
  ...
  inline const std::vector<ldmrsConfig::AbstractGroupDescriptionConstPtr> &ldmrsConfig::__getGroupDescriptions__()
  {
